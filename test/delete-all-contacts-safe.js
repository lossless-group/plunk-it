/**
 * SAFE Test script to delete all contacts from Plunk account
 * 
 ...
 * 
 * This version requires explicit confirmation before deletion.
 * 
 * Usage:
 * 1. Set PLUNK_SECRET in your .env file or environment variables
 * 2. Run: node delete-all-contacts-safe.js
 */
...
// For Node.js, we need to import readline for user input
...
/**
 * Delete all contacts with multiple confirmation steps
 */
async function deleteAllContacts() {
    try {
        ...
        const secondConfirmation = await getUserConfirmation('Type "DELETE ALL" to confirm deletion: ');
 ...
 */
async function main() {
    console.log('=== PLUNK CONTACT DELETION TOOL (SAFE VERSION) ===');
    console.log('This tool will delete ALL contacts from your Plunk account.');
    console.log('Multiple confirmations are required before deletion proceeds.');
    console.log('');
